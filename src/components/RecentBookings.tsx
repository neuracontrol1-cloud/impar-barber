...
export function RecentBookings() {
    ...
    return (
        <div className="relative notification-container">
            ...
            {/* Popover */}
            {isOpen && (
                <div className="fixed inset-x-4 top-20 sm:absolute sm:inset-auto sm:right-0 sm:top-full sm:mt-3 sm:w-[450px] bg-card/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl z-[100] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-300">
