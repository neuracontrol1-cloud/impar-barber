                ...
                >
                    ...
                    <div className="flex justify-center relative z-10">
                        ...
                        <div className="group cursor-pointer">
                            <div className="relative overflow-hidden w-72 h-96 border border-zinc-800 bg-zinc-950 rounded-sm">
                                {/* Premium Background Layer */}
                                <img
                                    src="/premium_portrait_bg.png"
                                ...
                                <img
                                    ...
                                    alt="Rafael Goulart"
                                    className="relative z-10 w-full h-full object-cover object-top transition-all duration-700 group-hover:scale-105 brightness-90 contrast-125 saturate-50 group-hover:brightness-100 group-hover:saturate-100"
                                />
